...
{
    public class ShortestRemainingTimeFirst : IStagger
    {
        ...
        public ShortestRemainingTimeFirst(IEnumerable<IProcess> initial) : this()
        {
        ...
        {
            IProcess next = Ready
                .OrderBy(process => process.RemainingSteps)
